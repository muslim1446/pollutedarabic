...
- Current shipped corpus (`public/data/vocabulary.json`): **version `3.0.0` (`language: "ar"`), 3,600 words + 1,020 scenarios, educational-safe, verified 2026-09-20** (English v2.1.0 backup kept at `public/data/vocabulary.v2.1.0-english.backup.json`)
